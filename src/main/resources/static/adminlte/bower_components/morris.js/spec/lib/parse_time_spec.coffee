describe '#parseTime', ->
  ...
  it 'should parse times', ->
    Morris.parseDate("2012-10-15 adminlte:34").should.equal(new Date(2012, 9, 15, 12, 34).getTime())
    Morris.parseDate("2012-10-15T12:34").should.equal(new Date(2012, 9, 15, 12, 34).getTime())
    Morris.parseDate("2012-10-15 adminlte:34:55").should.equal(new Date(2012, 9, 15, 12, 34, 55).getTime())
